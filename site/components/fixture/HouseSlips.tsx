/**
 * The house's three slips, safe to rogue, on the bookie's paper.
 *
 * Three SlipCards, one per tier, so house and models read as the same kind
 * of thing (docs/45). One paper only (docs/51): the receipt and boarding
 * pass went with their toggle. Nothing here is selected on the page: the
 * slips are built in the pipeline from the house's own numbers and the
 * recipes, or recomputed by FixtureLive from a reader's swaps.
 */
